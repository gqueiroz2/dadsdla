<table>
	...
	@elseif ($data['source'] == 'wbd')
		<tr>	
			<th style="background-color: #0047b3;  text-align: center;" colspan='16'> {{$data['regions']}} - Viewer WBD {{$data['year']}} - ({{$data['currencies']}}) </th>
		</tr>

		<tr>
			<td style="background-color: #0f243e;  text-align: center;">Total</td>
			<td style="background-color: #0f243e;  text-align: center; " colspan='13'></td>
			<td style="background-color: #0f243e;  text-align: center;" >{{$data['total']['sumGrossRevenue']}}</td>
			<td style="background-color: #0f243e;  text-align: center;" >{{$data['total']['sumNetRevenue']}}</td>
		</tr>
