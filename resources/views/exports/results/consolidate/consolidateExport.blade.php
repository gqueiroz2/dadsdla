...
<table>
	...
	<tr>
		...
		@for($d=0; $d < sizeof($data['mtxDN']['previousAdSales']); $d++)
			@if($d == 12)
				@if($data['mtxDN']['previousAdSales'][$d] > 0)
					<td style="color: #FFFFFF; font-weight: bold; background-color: #143052; text-align: right; ">{{number_format($data['mtxDN']['currentCorporate'][$d]/$data['mtxDN']['previousAdSales'][$d])}}</td>
				@else
					<td style=" color: #FFFFFF; font-weight: bold; background-color: #143052; ">0.0</td>
				@endif
			@else
				@if($data['mtxDN']['previousAdSales'][$d] > 0)
					<td style=" background-color: #c3d8ef; font-weight: bold; text-align: right; ">{{number_format($data['mtxDN']['currentCorporate'][$d]/$data['mtxDN']['previousAdSales'][$d])}}</td>
				@else
					<td style="background-color: #c3d8ef; font-weight: bold; ">0.0</td>
				@endif
			@endif
