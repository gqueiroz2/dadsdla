@if($data['regionName'] == "Brazil")
	...
	<table>
		...
		<tr>
			<td rowspan="9" style="text-align:center; background-color: #0f243e; font-weight: bold; color: #ffffff;"> TT </td>
		</tr>
		...
		<tr>
			<td style="background-color: #e7eff9;
			font-weight: bold; ">CMAPS</td>
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsTotal'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsTotal'][$m]}}</td>
			   @endif
			@endfor
			<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsTotal'][$m]}}</td>
			<td></td>
			@for($i=0; $i < 7; $i++)
				<td style="background-color: #e7eff9;
			font-weight: bold; text-align: right;"></td>
		...
		<tr>
			<td rowspan="9" style="text-align:center; background-color: #0070c0; font-weight: bold; color: #ffffff;">DISC</td>
		</tr>
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['targetValuesDiscovery'][$m]}}</td>
			   @else
			   		<td style="background-color: #f2f2f2; font-weight: bold; text-align: right;">{{$data['forRender']['targetValuesDiscovery'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRFDisc'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRFDisc'][$m]}}</td>
			   @endif
			@endfor
			<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRFDisc'][$m]}}</td>
			<td></td>
			<td style="background-color: #e7eff9; font-weight: bold; text-align: right;"> {{$data['forRender']['fcstAmountByStageExDisc'][1][4]}} </td>
	        <td style="background-color: #e7eff9; font-weight: bold; text-align: right;"> {{number_format($data['forRender']['fcstAmountByStageExDisc'][1][7],0)}} %</td>
	        <td style="background-color: #e7eff9; font-weight: bold; text-align: right;"> {{$data['forRender']['fcstAmountByStageExDisc'][1][0]}} </td>
	        <td style="background-color: #e7eff9; font-weight: bold; text-align: right;"> {{$data['forRender']['fcstAmountByStageExDisc'][1][1]}} </td>
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRevenueCYearDisc'][$m]}}</td>
			   @else
			   		<td style="background-color: #f2f2f2; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRevenueCYearDisc'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['pendingDisc'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['pendingDisc'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRevenuePYearDisc'][$m]}}</td>
			   @else
			   		<td style="background-color: #f2f2f2; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRevenuePYearDisc'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['RFvsTargetDisc'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['RFvsTargetDisc'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{number_format($data['forRender']['targetAchievementDisc'][$m],0)}} %</td>
			   @else
			   		<td style="background-color: #f2f2f2; font-weight: bold; text-align: right;">{{number_format($data['forRender']['targetAchievementDisc'][$m],0)}} %</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsDisc'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsDisc'][$m]}}</td>
			   @endif
			@endfor
			<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsDisc'][$m]}}</td>
			<td></td>
			@for($i=0; $i < 7; $i++)
				<td style="background-color: #e7eff9;
			font-weight: bold; text-align: right;"></td>
		...
		<tr>
			<td rowspan="9" style="text-align:center; background-color: #003c66; font-weight: bold; color: #ffffff;"> SONY </td>
		</tr> 
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['targetValuesSony'][$m]}}</td>
			   @else
			   		<td style="background-color: #f2f2f2; font-weight: bold; text-align: right;">{{$data['forRender']['targetValuesSony'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRFSony'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRFSony'][$m]}}</td>
			   @endif
			@endfor
			<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRFSony'][$m]}}</td>
			<td></td>
			<td style="background-color: #e7eff9; font-weight: bold; text-align: right;"> {{$data['forRender']['fcstAmountByStageExSony'][1][4]}} </td>
	        <td style="background-color: #e7eff9; font-weight: bold; text-align: right;"> {{number_format($data['forRender']['fcstAmountByStageExSony'][1][7],0)}} %</td>
	        <td style="background-color: #e7eff9; font-weight: bold; text-align: right;"> {{$data['forRender']['fcstAmountByStageExSony'][1][0]}} </td>
	        <td style="background-color: #e7eff9; font-weight: bold; text-align: right;"> {{$data['forRender']['fcstAmountByStageExSony'][1][1]}} </td>
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRevenueCYearSony'][$m]}}</td>
			   @else
			   		<td style="background-color: #f2f2f2; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRevenueCYearSony'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['pendingSony'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['pendingSony'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRevenuePYearSony'][$m]}}</td>
			   @else
			   		<td style="background-color: #f2f2f2; font-weight: bold; text-align: right;">{{$data['forRender']['executiveRevenuePYearSony'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['RFvsTargetSony'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['RFvsTargetSony'][$m]}}</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{number_format($data['forRender']['targetAchievementSony'][$m],0)}} %</td>
			   @else
			   		<td style="background-color: #f2f2f2; font-weight: bold; text-align: right;">{{number_format($data['forRender']['targetAchievementSony'][$m],0)}} %</td>
			   @endif
			@endfor
		...
		<tr>
			...
			@for($m=0; $m < sizeof ($data['month']); $m++)
			   @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
			   		<td style="background-color: #c3d8ef; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsSony'][$m]}}</td>
			   @else
			   		<td style="background-color: #e7eff9; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsSony'][$m]}}</td>
			   @endif
			@endfor
			<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: right;">{{$data['forRender']['cmapsSony'][$m]}}</td>
			<td></td>
			@for($i=0; $i < 7; $i++)
				<td style="background-color: #e7eff9;
			font-weight: bold; text-align: right;"></td>
	...
	<table>
	    ...
	    <tr>
			<td rowspan="7" style="text-align:center; background-color: #0f243e; font-weight: bold; color: #ffffff;"> TT </td>
		</tr>    
	    <tr>
	    ...
	    <tr>
	        ...
	        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
	            @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
	                <td style=" background-color: #c3d8ef; font-weight: bold; text-align:right;">{{$data['forRender']['rollingFCSTDisc'][$c][$m] + $data['forRender']['rollingFCSTSony'][$c][$m]}}</td>
	            @else
	                <td style=" background-color: #e6e6e6; font-weight: bold; text-align:right;">{{$data['forRender']['rollingFCSTDisc'][$c][$m] + $data['forRender']['rollingFCSTSony'][$c][$m]}}</td>
	            @endif
	        @endfor
	        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:right;">{{$data['forRender']['rollingFCSTDisc'][$c][$m] + $data['forRender']['rollingFCSTSony'][$c][$m]}}</td>
	        <td></td>
	    ...
	    <tr>
	     ...
	     <tr>
	        <td style="background-color:#c9d8e8; text-align:left; font-weight: bold;">CMAPS</td>
	        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
	            @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
	                <td style=" background-color: #c3d8ef; font-weight: bold; text-align:right;">{{$data['forRender']['cmapsClientDisc'][$c][$m] + $data['forRender']['cmapsClientSony'][$c][$m]}}</td>
	            @else
	                <td style=" background-color: #e6e6e6; font-weight: bold; text-align:right;">{{$data['forRender']['cmapsClientDisc'][$c][$m] + $data['forRender']['cmapsClientSony'][$c][$m]}}</td>
	            @endif
	        @endfor
	        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:right;">{{$data['forRender']['cmapsClientDisc'][$c][$m] + $data['forRender']['cmapsClientSony'][$c][$m]}}</td>
	        <td></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
		...
		<tr>
			<td rowspan="7" style="text-align:center; background-color: #0070c0; font-weight: bold; color: #ffffff;">DISC</td>
		</tr>
		<tr>
	        <td style="background-color:#dbe5f0; text-align:left; font-weight: bold;"> Rolling Fcast {{$data['cYear']}}</td>
	        @for($m=0; $m < sizeof ($data['month']) ; $m++)
	    ...
	    <tr>
	        ...
	        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
	            @if($data['forRender']['rollingFCSTDisc'][$c] || $data['forRender']['rollingFCSTDisc'][$c] != null)
		            ...
		            @else
		                <td style=" background-color: #e6e6e6; font-weight: bold; text-align:right;">{{$data['forRender']['rollingFCSTDisc'][$c][$m]}}</td>
		            @endif
		        @else
		         	@if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
		                <td style=" background-color: #c3d8ef; font-weight: bold; text-align:right;">0</td>
		            @else
		                <td style=" background-color: #e6e6e6; font-weight: bold; text-align:right;">0</td>
		            @endif
		        @endif
	        @endfor
	        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:right;">{{$data['forRender']['rollingFCSTDisc'][$c][$m]}}</td>
	        <td></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
	    ...
	    <tr>
	        ...
	        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
	            @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
	                <td style=" background-color: #c3d8ef; font-weight: bold; text-align:right;">{{$data['forRender']['cmapsClientDisc'][$c][$m]}}</td>
	            @else
	                <td style=" background-color: #e6e6e6; font-weight: bold; text-align:right;">{{$data['forRender']['cmapsClientDisc'][$c][$m]}}</td>
	            @endif
	        @endfor
	        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:right;">{{$data['forRender']['cmapsClientDisc'][$c][$m]}}</td>
	        <td></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
	   ...
	   <!-- ------------SONY------------ -->
	    ...
	    <tr>
			<td rowspan="7" style="text-align:center; background-color: #003c66; font-weight: bold; color: #ffffff;"> SONY </td>
		</tr>    
	    <tr>
	        <td style="background-color:#dbe5f0; text-align:left; font-weight: bold;"> Rolling Fcast {{$data['cYear']}}</td>
	        @for($m=0; $m < sizeof ($data['month']) ; $m++)
	    ...
	    <tr>
	        <td style="background-color:#c9d8e8; text-align:left; font-weight: bold;">Manual Estimation</td>
	        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
	        	@if($data['forRender']['rollingFCSTSony'][$c])
		            @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
		                <td style=" background-color: #c3d8ef; font-weight: bold; text-align:right;">{{$data['forRender']['rollingFCSTSony'][$c][$m]}}</td>
		            @else
		                <td style=" background-color: #e6e6e6; font-weight: bold; text-align:right;">{{$data['forRender']['rollingFCSTSony'][$c][$m]}}</td>
		            @endif
		        @else
		         	@if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
		                <td style=" background-color: #c3d8ef; font-weight: bold; text-align:right;">0</td>
		        ...
		        @endif
	        @endfor
	        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:right;">{{$data['forRender']['rollingFCSTSony'][$c][$m]}}</td>
	        <td></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
	    ...
	    <tr>
	        ...
	        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
	            @if ($m == 3 || $m == 7 || $m == 11 || $m == 15 )
	                <td style=" background-color: #c3d8ef; font-weight: bold; text-align:right;">{{$data['forRender']['cmapsClientSony'][$c][$m]}}</td>
	            @else
	                <td style=" background-color: #e6e6e6; font-weight: bold; text-align:right;">{{$data['forRender']['cmapsClientSony'][$c][$m]}}</td>
	            @endif
	        @endfor
	        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:right;">{{$data['forRender']['cmapsClientSony'][$c][$m]}}</td>
	        <td></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
	        <td style="background-color: #e6e6e6;"></td>
...
@else
	...
	<table>
		...
		<tr>
			<td rowspan="8" style="text-align:center; background-color: #0f243e; font-weight: bold; color: #ffffff;"> TT </td>
		</tr>
		...
		<tr>
			<td rowspan="8" style="text-align:center; background-color: #0070c0; font-weight: bold; color: #ffffff;">DISC</td>
		</tr>
		...
		<tr>
			<td rowspan="8" style="text-align:center; background-color: #003c66; font-weight: bold; color: #ffffff;"> SONY </td>
		</tr> 
