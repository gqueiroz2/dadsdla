...
<table>
	<tr>
		...
		@for($m=0; $m < sizeof($data['month']); $m++)
			@if($m == 3 || $m == 7 || $m == 11 || $m == 15)
				<td style="background-color: #143052; color: #ffffff;font-weight: bold; text-align: left;">{{$data['month'][$m]}}</td>
			@else
				<td style="background-color: #4f81bd; color: #ffffff; font-weight: bold; text-align: left;">{{$data['month'][$m]}}</td>
			@endif
		@endfor
		<td style=" background-color: #0f243e; color: #ffffff; font-weight: bold; text-align: left;">Total</td>
		<td></td>
	...
	<tr>
		...
		@for($m=0; $m < sizeof ($data['month']); $m++)
		   ...
		   @endif
		@endfor
		<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: left;">{{$data['forRender']['targetValues'][$m]}}</td>
		<td></td>
		@for($i=0; $i < 8; $i++)
			<td style="background-color: #c8d8e9;
	...
	<tr>
		...
		@for($m=0; $m < sizeof ($data['month']); $m++)
		   ...
		   @endif
		@endfor
		<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: left;">{{$data['forRender']['executiveRF'][$m]}}</td>
		<td></td>
	...
	<tr>
		...
		@for($m=0; $m < sizeof ($data['month']); $m++)
		   ...
		   @endif
		@endfor
		<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: left;">{{$data['forRender']['executiveRevenueCYear'][$m]}}</td>
		<td></td>
		@for($i=0; $i < 8; $i++)
			<td style="background-color: #c8d8e9;
		font-weight: bold; text-align: left;"></td>
	...
	<tr>
		...
		@for($m=0; $m < sizeof ($data['month']); $m++)
		   ...
		   @endif
		@endfor
		<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: left;">{{$data['forRender']['pending'][$m]}}</td>
		<td></td>
		@for($i=0; $i < 8; $i++)
			<td style="background-color: #e7eff9;
		font-weight: bold; text-align: left;"></td>
	...
	<tr>
		...
		@for($m=0; $m < sizeof ($data['month']); $m++)
		   ...
		   @endif
		@endfor
		<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: left;">{{$data['forRender']['executiveRevenuePYear'][$m]}}</td>
		<td></td>
		@for($i=0; $i < 8; $i++)
			<td style="background-color: #c8d8e9;
		font-weight: bold; text-align: left;"></td>
	...
	<tr>
		...
		@for($m=0; $m < sizeof ($data['month']); $m++)
		   ...
		   @endif
		@endfor
		<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: left;">{{$data['forRender']['RFvsTarget'][$m]}}</td>
		<td></td>
		@for($i=0; $i < 8; $i++)
			<td style="background-color: #e7eff9;
		font-weight: bold; text-align: left;"></td>
	...
	<tr>
		...
		@for($m=0; $m < sizeof ($data['month']); $m++)
		   ...
		   @endif
		@endfor
		<td style="background-color: #143052; color: #ffffff; font-weight: bold; text-align: left;">{{$data['forRender']['targetAchievement'][$m]}} %</td>
		<td></td>
		@for($i=0; $i < 8; $i++)
			<td style="background-color: #c8d8e9;
		font-weight: bold; text-align: left;"></td>
...
<table>
	<tr>
		<td></td>
		<td style=" background-color: #0f243e; color: #ffffff; font-weight: bold;">{{$data['forRender']['client'][$c]['clientName']}} - {{$data['forRender']['client'][$c]['agencyName']}} </td>
		@for($m=0; $m < sizeof($data['month']); $m++)
			@if($m == 3 || $m == 7 || $m == 11 || $m == 15)
				<td style="background-color: #143052; color: #ffffff; font-weight: bold;">{{$data['month'][$m]}}</td>
			@else
				<td style="background-color: #4f81bd; color: #ffffff; font-weight: bold;">{{$data['month'][$m]}}</td>
			@endif
		@endfor
	...
	<tr>
        ...
        @for($m=0; $m < sizeof ($data['month']) ; $m++)
	        ...
	        @endif
	    @endfor
	    <td style="background-color: #143052; text-align:left; font-weight: bold; color: #ffffff;">
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:left;">{{$data['forRender']['clientRevenuePYearDisc'][$c][$m]}}</td>
        <td></td>
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style="background-color: #143052; text-align: left; font-weight: bold; color: #ffffff;">{{$data['forRender']['clientRevenueCYearDisc'][$c][$m]}}</td>
        <td></td>
        @for ($i=0; $i < 8; $i++) 
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style="background-color: #143052; text-align: left; font-weight: bold; color: #ffffff;">{{$data['forRender']['rollingFCSTDisc'][$c][$m] - $data['forRender']['clientRevenuePYearDisc'][$c][$m]}}</td>
        <td></td>
        @for ($i=0; $i < 8; $i++) 
        	<td style="background-color: #c8d8e9; font-weight: bold; text-align: left;"></td>
        @endfor
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:left;">{{$data['forRender']['clientRevenuePYearSony'][$c][$m]}}</td>
        <td></td>
        <td style="background-color: #e6e6e6;"></td>
        <td style="background-color: #e6e6e6;"></td>
        <td style="background-color: #e6e6e6;"></td>
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style="background-color: #143052; text-align: left; font-weight: bold; color: #ffffff;">{{$data['forRender']['clientRevenueCYearSony'][$c][$m]}}</td>
        <td></td>
        @for ($i=0; $i < 8; $i++) 
        	<td style="background-color: #c8d8e9; font-weight: bold; text-align: left"></td>
        @endfor
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style="background-color: #143052; text-align: left; font-weight: bold; color: #ffffff;">{{$data['forRender']['rollingFCSTSony'][$c][$m] - $data['forRender']['clientRevenuePYearSony'][$c][$m]}}</td>
        <td></td>
        @for ($i=0; $i < 8; $i++) 
        	<td style="background-color: #c8d8e9; font-weight: bold; text-align: left;"></td>
        @endfor
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style=" background-color: #143052; font-weight: bold; color: #ffffff; text-align:left;">{{$data['forRender']['clientRevenuePYearSony'][$c][$m] + $data['forRender']['clientRevenuePYearDisc'][$c][$m]}}</td>
        <td></td>
        <td style="background-color: #e6e6e6;"></td>
        <td style="background-color: #e6e6e6;"></td>
        <td style="background-color: #e6e6e6;"></td>
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style="background-color: #143052; text-align: left; font-weight: bold; color: #ffffff;">{{$data['forRender']['clientRevenueCYearSony'][$c][$m] + $data['forRender']['clientRevenueCYearDisc'][$c][$m]}}</td>
        <td></td>
        @for ($i=0; $i < 8; $i++) 
        	<td style="background-color: #c8d8e9; font-weight: bold; text-align: left"></td>
        @endfor
    ...
    <tr>
        ...
        @for ($m=0; $m < sizeof($data['month']) ; $m++) 
            ...
            @endif
        @endfor
        <td style="background-color: #143052; text-align: left; font-weight: bold; color: #ffffff;">{{($data['forRender']['rollingFCSTSony'][$c][$m] - $data['forRender']['clientRevenuePYearSony'][$c][$m]) + ($data['forRender']['rollingFCSTDisc'][$c][$m] - $data['forRender']['clientRevenuePYearDisc'][$c][$m])}}</td>
        <td></td>
        @for ($i=0; $i < 8; $i++) 
        	<td style="background-color: #c8d8e9; font-weight: bold; text-align: left;"></td>
        @endfor
