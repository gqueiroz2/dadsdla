                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('resetPassword')}}">
                            ...
                            <div class="col">
                                <center>
                                    <span class="alert alert-success" style="width: 100%">
                                        Please check your email and type the Token you received!
                                    </span>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="token" type="token" class="form-control {{ $errors->has('token') ? ' is-invalid' : '' }}" name="token" required autofocus>  
                                @if ($errors->has('token'))                                    
