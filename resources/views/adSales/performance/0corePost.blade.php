...
@section('content')
	<div class="container-fluid">		
		...
		<div class="row mt-2" style='width:100%;'>
			<div class="col" style='width:100%; margin-right: -5%;' >
				<div class="form-group" style='width:100%;'>
					<div class="form-inline" style='width:100%;'>
						<div class="row" style="width: 100%;">
							<div class="col-sm" id="type1" style=" width: 100%; margin-top: 2%; display: block; margin-right: -5%;">
								{{$render->case1($mtx)}}
							</div>
						</div>
						<div class="row" style="width: 100%;">
							<div class="col-sm" id="type2" style=" width: 100%; margin-top: 2%; display: none; margin-right: -5%;">
								{{$render->case2($mtx)}}

							</div>
						</div>
						<div class="row" style="width: 100%;">
							<div class="col-sm" id="type3" style=" width: 100%; margin-top: 2%; display: none; margin-right: -5%;">
								{{$render->case3($mtx)}}
							</div>
						</div>
						<div class="row" style="width: 100%;">
							<div class="col-sm" id="type4" style=" width: 100%; margin-top: 2%; display: none; margin-right: -5%;">
								{{$render->case4($mtx)}}
							</div>
						</div>
					</div>
