			...
			<div class="container-fluid" id="body">
				<div class="row ">
					<div class="col"> 				       			
				        ...
				        <table style='width: 100%; zoom: 85%; font-size: 16px;'>
				        	<tr>
				        		<th class='newBlue center' colspan="3" style="font-size: 16px; border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">Net investment</th>
				        	</tr>
				        ...
				        <table style='width: 100%; zoom: 85%; font-size: 16px;'>
							<tr class="medBlue center" >
								<td class="col" style="width: 10%; border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">{{$year-3}}</td>
				        		@for($x = 0; $x<sizeof($brand); $x++)
				        			<td class="col" style="width: 15%; border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">{{$brand[$x]['name']}}</td>
				        		@endfor
				        		<td class="col" style="border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">TOTAL</td>
				        	</tr>
				        	@for($b = 0; $b < sizeof($clientsByAE) ; $b++)	
								<tr class='center' style='font-size:16px;'>
									...
									@for ($c=0; $c <sizeof($brand) ; $c++) 
     									<td style="width: 15%; border-style:solid; border-color: black; border-width: 0px 1px 0px 1px;">{{number_format($tableBrandPppyear[$b][$c]['SUM(net_value)'],0,',','.')}}</td>	
     								@endfor
								</tr>
							@endfor
							<tr>
				        ...
				        <table style='width: 100%; zoom: 85%; font-size: 16px;'>
							<tr class="medBlue center" >
								<td class="col" style="width: 10%; border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">{{$year-2}}</td>
				        		@for($x = 0; $x<sizeof($brand); $x++)
				        			<td class="col" style="width: 15%; border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">{{$brand[$x]['name']}}</td>
				        		@endfor
				        		<td class="col" style="border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">TOTAL</td>
				        	...
				        	@for($b = 0; $b < sizeof($clientsByAE) ; $b++)	
								<tr class='center' style='font-size:16px;'>
									<td class='{{$color[$b]}}' style="width: 10%; border-style:solid; border-color:black; border-width: 0px 1px 0px 1px;">{{$clientsByAE[$b]['clientName']}}</td>
									@for ($c=0; $c <sizeof($brand) ; $c++) 
     									<td style="width: 15%; border-style:solid; border-color: black; border-width: 0px 1px 0px 1px;">{{number_format($tableBrandPpyear[$b][$c]['SUM(net_value)'],0,',','.')}}</td>	
     								@endfor
								</tr>
							@endfor
							<tr>
				        ...
				        <table style='width: 100%; zoom: 85%; font-size: 16px;'>
							<tr class="medBlue center" >
								<td class="col" style="width: 10%; border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">{{$year-1}}</td>
				        		@for($x = 0; $x<sizeof($brand); $x++)
				        			<td class="col" style="width: 15%; border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">{{$brand[$x]['name']}}</td>
				        		@endfor
				        		<td class="col" style="border-style:solid; border-color: black; border-width: 1px 1px 1px 1px;">TOTAL</td>
