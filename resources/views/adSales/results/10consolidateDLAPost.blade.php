	...
	<div class="row">
		<div class="col">
			<form method="POST" action="{{ route('consolidateResultsPostDLA') }}" runat="server"  onsubmit="ShowLoading()">
				...
				<div class="row">
					<div class="col-sm">
						<label class="labelLeft" style='z-index: 999;'><span class="bold"> Region: </span></label>
					...
					<div class="container-fluid" style='width: 100%; zoom: 85%;font-size: 16px;'>
				        ...
				        @for ($c=0; $c < sizeof($mtx['previousAdSales']); $c++)
						    <div class="row mt-2">
						    	<table style='width: 100%; zoom: 85%;font-size: 16px;'>
						        	<tr class="center">
						        		<td class='lightBlue center' style="width: 7% !important;"> {{$typeSelectS[$c]['salesRep']}} - ({{$typeSelectS[$c]['region']}}) </td>
							        	@for($m=0; $m < sizeof($month); $m++)
							        		<td class='lightGrey center' style="width: 4%;"> {{ $month[$m] }} </td>
							        	@endfor
							        		<td class='darkBlue center' style="width: 4%;"> Total </td>
					...
					<div class="container-fluid" style='width: 100%; zoom: 85%;font-size: 16px;'>
						<div class="row">
							...
							<div class="col lightBlue">
								<center>
									<span style='font-size:24px;'> 
										Consolidate - {{$typeShow}} : (USD/{{strtoupper($value)}})
									</span>
								</center>
							</div>
						</div>
