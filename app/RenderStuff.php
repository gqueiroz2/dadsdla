								...
								*/
								$client = $cli->getClient($con);
									...
									echo "<div class='row mt-1'>";
										echo "<div class='col-2'><center> ".($n+1)." </center></div>";
										...
										echo "<div class='col-4'>";	
											...
											echo "</select>";
										echo "</div>";
										echo "<div class='col-4'><input type='text' class='form-control' readonly='true' style='width:100%;' name='$dependencies[$d]-unit-$n' value='".$newValues[$dependencies[$d]][$n]."'></div>";
