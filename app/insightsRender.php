...
class insightsRender extends Render{
	...
	public function assemble($mtx,$currencies,$value,$regions,$total){
		...
		echo "<table style='width: 100%;'>";
			echo "<tr>";
				echo "<th class='newBlue center' colspan='19' style='font-size:22px;'> $regions - Insights - ($newCurrency/$newValue) </th>";
			echo "</tr>";
		
					echo "<tr class='newBlue center'>";
						echo "<td style='width:5%; '>Brand</td>";
						echo "<td style='width:3%;'>Sales Rep</td>";
						...
						echo "<td style='width:5%;'>Media Item</td>";
						echo "<td style='width:5%;'>Spot Status</td>";
						echo "<td style='width:7%;'>Date Event</td>";
						echo "<td style='width:5%;'>Unit Start Time</td>";
						echo "<td style='width:5%;'>Duration Spot</td>";
						echo "<td style='width:5%;'>Copy Key</td>";
						echo "<td style='width:7%;'>Duration Impression</td>";
						echo "<td style='width:15%;'>Schedule Event</td>";
